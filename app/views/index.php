<style>
<?php include '../../TeVi/public/css/index_style.css'; ?>
</style>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div id="section3" class="sections">
            <div class="content">
                ...
                <p>
                    ...
                    <label>Year</label>
                    <input type="number" min="1970" max="2017" step="1" value="" size="6" name="Year">

                    <label>Month</label>
                    <input type="number" min="1" max="12" step="1" value="" size="6" name="Month">

                    <label>Day</label>
                    <input type="number" min="1" max="31" step="1" value="" size="6" name="Day">

                    <label>Time</label>
                    <select id = "Time" >
                        <option value = "1"></option>
                        <option value = "2">Less than 24 hours</option>
                        <option value = "3">More than 24 hours</option>
                    </select>

                    <label>Country code</label>
                    <input type="number" min="4" max="1004" step="1" value="" size="6" name="CountryCode">
                    ...
                    <input type="number" min="1" max="12" step="1" value="" size="6" name="RegionCode">
                    ...
                    <select id = "Region" >
                        ...
                        <option value = "5">Western Europe</option>
                        ...
                        <option value = "12">Ipsum</option>
                        <option value = "13">Lorem</option>
                    </select>
